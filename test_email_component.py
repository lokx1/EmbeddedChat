...
async def test_email_component():
    ...
    try:
        ...
        print("Make sure you're in the EmbeddedChat directory and backend is properly configured")
...
if __name__ == "__main__":
    ...
    if not os.path.exists("backend"):
        print("❌ Backend directory not found. Please run from EmbeddedChat root directory.")
        sys.exit(1)
